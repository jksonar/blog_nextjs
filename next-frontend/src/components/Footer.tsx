      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1 md:col-span-1">
            <Link href="/" className="flex items-center gap-2 text-xl font-bold text-white mb-4">
              <span className="flex-shrink-0 text-primary-500">
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 36 36" fill="currentColor">
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/blog?category=technology" className="text-gray-400 hover:text-white transition duration-150">
                  Technology
                </Link>
              </li>
              <li>
                <Link href="/blog?category=lifestyle" className="text-gray-400 hover:text-white transition duration-150">
                  Lifestyle
                </Link>
              </li>
              <li>
                <Link href="/blog?category=business" className="text-gray-400 hover:text-white transition duration-150">
                  Business
                </Link>
              </li>
              <li>
                <Link href="/blog?category=health" className="text-gray-400 hover:text-white transition duration-150">
                  Health & Wellness
                </Link>
              </li>
              <li>
                <Link href="/blog?category=travel" className="text-gray-400 hover:text-white transition duration-150">
                  Travel
                </Link>
              </li>
            </ul>
        ...
        <div className="pt-8 mt-8 border-t border-gray-800 text-center md:flex md:justify-between md:text-left">
          ...
          <div className="mt-4 md:mt-0">
            <Link href="/terms" className="text-gray-400 hover:text-white transition duration-150 mx-2">
              Terms of Service
            </Link>
            <Link href="/privacy" className="text-gray-400 hover:text-white transition duration-150 mx-2">
              Privacy Policy
            </Link>
            <Link href="/cookies" className="text-gray-400 hover:text-white transition duration-150 mx-2">
              Cookie Policy
            </Link>
          </div>
        </div>
